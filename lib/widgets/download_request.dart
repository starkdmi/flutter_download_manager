    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            return builder(
                context, DownloadWidgetState.failed, null, snapshot.error);
          }
          ...
          if (snapshot.hasData) {
            ...
            if (data is double) {
              return builder(
                  context, DownloadWidgetState.downloading, data, null);
            }
            ...
            switch (data as DownloadState) {
              ...
              case DownloadState.resumed:
                return builder(
                    context, DownloadWidgetState.downloading, null, null);
              case DownloadState.paused:
                return builder(context, DownloadWidgetState.paused,
                    request!.progress, null);
              case DownloadState.cancelled:
                return builder(
                    context, DownloadWidgetState.initial, null, null);
              case DownloadState.finished:
                return builder(
                    context, DownloadWidgetState.downloaded, 1.0, null);
            }
          }
